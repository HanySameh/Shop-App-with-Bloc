...
class UserAuth {
  UserAuth._internalConstructor();

  static final UserAuth _instance = UserAuth._internalConstructor();
  ...
  Future<dynamic> signUpNewUser(UserModel userModel) async {
    try {
      ...
      UserModel userWithUserId =
          userModel.updateCurrentUserModel(userId: createNewUser.user!.uid);
      await _firebaseFirestore
          .collection(_kUserCollectionKey)
          .doc(createNewUser.user!.uid)
          .set(
            userWithUserId.toJson(),
          );
      return userModel;
